...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sma_diagnosis', 'id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Respiratory.id'
        db.add_column('sma_respiratory', 'id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Notes.id'
        db.add_column('sma_notes', 'id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'FeedingFunction.id'
        db.add_column('sma_feedingfunction', 'id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'MotorFunction.id'
        db.add_column('sma_motorfunction', 'id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Surgery.id'
        db.add_column('sma_surgery', 'id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('sma_diagnosis', 'id')

        # Deleting field 'Respiratory.id'
        db.delete_column('sma_respiratory', 'id')

        # Deleting field 'Notes.id'
        db.delete_column('sma_notes', 'id')

        # Deleting field 'FeedingFunction.id'
        db.delete_column('sma_feedingfunction', 'id')

        # Deleting field 'MotorFunction.id'
        db.delete_column('sma_motorfunction', 'id')

        # Deleting field 'Surgery.id'
        db.delete_column('sma_surgery', 'id')
