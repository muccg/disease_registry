...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute('ALTER TABLE sma_diagnosis DROP CONSTRAINT sma_diagnosis_pkey CASCADE')
        db.create_primary_key('sma_diagnosis', ['id'])

        # Changing field 'Diagnosis.patient'
        db.alter_column('sma_diagnosis', 'patient_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['patients.Patient']))


        # Changing field 'Respiratory.diagnosis'
        db.alter_column('sma_respiratory', 'diagnosis_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sma.Diagnosis'], unique=True))
        db.delete_primary_key('sma_respiratory')
        db.create_primary_key('sma_respiratory', ['id'])


        # Changing field 'Notes.id'
        db.alter_column('sma_notes', 'diagnosis_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sma.Diagnosis'], unique=True))
        db.delete_primary_key('sma_notes')
        db.create_primary_key('sma_notes', ['id'])

        # Changing field 'FeedingFunction.id'
        db.alter_column('sma_feedingfunction', 'diagnosis_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sma.Diagnosis'], unique=True))
        db.delete_primary_key('sma_feedingfunction')
        db.create_primary_key('sma_feedingfunction', ['id'])

        # Changing field 'MotorFunction.diagnosis'
        db.alter_column('sma_motorfunction', 'diagnosis_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sma.Diagnosis'], unique=True))
        db.delete_primary_key('sma_motorfunction')
        db.create_primary_key('sma_motorfunction', ['id'])


        # Changing field 'Surgery.id'
        db.alter_column('sma_surgery', 'diagnosis_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sma.Diagnosis'], unique=True))
        db.delete_primary_key('sma_surgery')
        db.create_primary_key('sma_surgery', ['id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Surgery', fields ['id']
        db.delete_unique('sma_surgery', ['id'])

        # Removing unique constraint on 'MotorFunction', fields ['id']
        db.delete_unique('sma_motorfunction', ['id'])

        # Removing unique constraint on 'FeedingFunction', fields ['id']
        db.delete_unique('sma_feedingfunction', ['id'])

        # Removing unique constraint on 'Notes', fields ['id']
        db.delete_unique('sma_notes', ['id'])

        # Removing unique constraint on 'Respiratory', fields ['id']
        db.delete_unique('sma_respiratory', ['id'])

        # Removing unique constraint on 'Diagnosis', fields ['id']
        db.delete_unique('sma_diagnosis', ['id'])


        # Changing field 'Diagnosis.patient'
        db.alter_column('sma_diagnosis', 'patient_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, primary_key=True, to=orm['patients.Patient']))

        # Changing field 'Diagnosis.id'
        db.alter_column('sma_diagnosis', 'id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Respiratory.diagnosis'
        db.alter_column('sma_respiratory', 'diagnosis_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sma.Diagnosis'], unique=True, primary_key=True))

        # Changing field 'Respiratory.id'
        db.alter_column('sma_respiratory', 'id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Notes.id'
        db.alter_column('sma_notes', 'id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Notes.diagnosis'
        db.alter_column('sma_notes', 'diagnosis_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sma.Diagnosis'], unique=True, primary_key=True))

        # Changing field 'FeedingFunction.id'
        db.alter_column('sma_feedingfunction', 'id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'FeedingFunction.diagnosis'
        db.alter_column('sma_feedingfunction', 'diagnosis_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sma.Diagnosis'], unique=True, primary_key=True))

        # Changing field 'MotorFunction.diagnosis'
        db.alter_column('sma_motorfunction', 'diagnosis_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sma.Diagnosis'], unique=True, primary_key=True))

        # Changing field 'MotorFunction.id'
        db.alter_column('sma_motorfunction', 'id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Surgery.id'
        db.alter_column('sma_surgery', 'id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Surgery.diagnosis'
        db.alter_column('sma_surgery', 'diagnosis_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sma.Diagnosis'], unique=True, primary_key=True))
