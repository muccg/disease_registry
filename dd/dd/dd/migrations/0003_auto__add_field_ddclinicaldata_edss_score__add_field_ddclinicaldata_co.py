...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DDClinicalData.edss_score'
        db.add_column(u'dd_ddclinicaldata', 'edss_score',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DDClinicalData.comments'
        db.add_column(u'dd_ddclinicaldata', 'comments',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DDClinicalData.edss_score'
        db.delete_column(u'dd_ddclinicaldata', 'edss_score')

        # Deleting field 'DDClinicalData.comments'
        db.delete_column(u'dd_ddclinicaldata', 'comments')
