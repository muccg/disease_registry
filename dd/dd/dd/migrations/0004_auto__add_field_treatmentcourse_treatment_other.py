...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TreatmentCourse.treatment_other'
        db.add_column(u'dd_treatmentcourse', 'treatment_other',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TreatmentCourse.treatment_other'
        db.delete_column(u'dd_treatmentcourse', 'treatment_other')
