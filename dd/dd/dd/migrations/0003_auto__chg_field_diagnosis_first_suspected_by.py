...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('dd_diagnosis', 'first_suspected_by', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

    def backwards(self, orm):

        # Changing field 'Diagnosis.first_suspected_by'
        db.alter_column('dd_diagnosis', 'first_suspected_by', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
