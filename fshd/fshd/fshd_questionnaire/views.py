...
def clinical(request):
    ...
    form_definitions = (
        ...
        #("Current best motor function", MotorFunctionForm, save_default),
        #("Wheelchair of mobility scooter use", WheelchairForm, save_default),
        ("Heart Condition", HeartForm, save_default),
        ...
        ("Pregnancy", PregnancyForm, save_default),
    ...
    return render_to_response("fshd/questionnaire/clinical.html", {
...
def personal(request):
    ...
    return render_to_response("fshd/questionnaire/personal.html",
...
def index(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render_to_response("fshd/questionnaire/index.html", {"form": form }, context_instance=RequestContext(request))
    else:
    ...
    return render_to_response("fshd/questionnaire/index.html", {
        "form": form
    }, context_instance=RequestContext(request))

def thanks(request):
    return render_to_response("fshd/questionnaire/thanks.html", {})
