...
ROOT_URLCONF = 'fshd.urls'

SECRET_KEY = 'b530430065479793bbc5570cf21582ed'
...
CSRF_COOKIE_NAME = "csrftoken_registry_fshd"

SESSION_COOKIE_NAME = "registry_fshd"
...
try:
    print "Attempting to import local settings as appsettings.fshd"
    from appsettings.fshd import *
    print "Successfully imported appsettings.fshd"
except ImportError, e:
    print "Failed to import appsettings.fshd"
