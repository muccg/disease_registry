...
BuildRequires: python-setuptools postgresql93-devel.x86_64
Requires: httpd mod_wsgi postgresql93-libs.x86_64
...
install -D ../centos/dd/%{name}.ccg %{buildroot}/etc/httpd/conf.d/%{name}.ccg
