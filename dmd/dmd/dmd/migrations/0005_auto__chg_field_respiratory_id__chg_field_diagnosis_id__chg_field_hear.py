...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute("CREATE SEQUENCE dmd_diagnosis_id_seq")
        db.execute("SELECT setval('dmd_diagnosis_id_seq', (SELECT MAX(id) FROM dmd_diagnosis))")
        db.execute("ALTER TABLE dmd_diagnosis ALTER COLUMN id SET DEFAULT nextval('dmd_diagnosis_id_seq'::regclass)")

        db.execute("CREATE SEQUENCE dmd_motorfunction_id_seq")
        db.execute("SELECT setval('dmd_motorfunction_id_seq', (SELECT MAX(id) FROM dmd_motorfunction))")
        db.execute("ALTER TABLE dmd_motorfunction ALTER COLUMN id SET DEFAULT nextval('dmd_motorfunction_id_seq'::regclass)")

        db.execute("CREATE SEQUENCE dmd_respiratory_id_seq")
        db.execute("SELECT setval('dmd_respiratory_id_seq', (SELECT MAX(id) FROM dmd_respiratory))")
        db.execute("ALTER TABLE dmd_respiratory ALTER COLUMN id SET DEFAULT nextval('dmd_respiratory_id_seq'::regclass)")

        db.execute("CREATE SEQUENCE dmd_heart_id_seq")
        db.execute("SELECT setval('dmd_heart_id_seq', (SELECT MAX(id) FROM dmd_heart))")
        db.execute("ALTER TABLE dmd_heart ALTER COLUMN id SET DEFAULT nextval('dmd_heart_id_seq'::regclass)")

        db.execute("CREATE SEQUENCE dmd_notes_id_seq")
        db.execute("SELECT setval('dmd_notes_id_seq', (SELECT MAX(id) FROM dmd_notes))")
        db.execute("ALTER TABLE dmd_notes ALTER COLUMN id SET DEFAULT nextval('dmd_notes_id_seq'::regclass)")
    ...
    def backwards(self, orm):
        ...
        db.alter_column('dmd_respiratory', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Diagnosis.id'
        db.alter_column('dmd_diagnosis', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Heart.id'
        db.alter_column('dmd_heart', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'MotorFunction.id'
        db.alter_column('dmd_motorfunction', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Notes.id'
        db.alter_column('dmd_notes', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Steroids.id'
        db.alter_column('dmd_steroids', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))

        # Changing field 'Surgery.id'
        db.alter_column('dmd_surgery', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
