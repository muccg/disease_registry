...
function ci_staging_selenium() {
    ...
    ccg ${AWS_STAGING_INSTANCE} dsudo:'export SITE_URL=http://localhost/dmd'
    ...
    ccg ${AWS_STAGING_INSTANCE} dsudo:'killall httpd || true'
    ccg ${AWS_STAGING_INSTANCE} dsudo:'service httpd start'
    ccg ${AWS_STAGING_INSTANCE} dsudo:'export SITE_URL=http://localhost/sma'
    ...
    ccg ${AWS_STAGING_INSTANCE} dsudo:'killall httpd || true'
    ccg ${AWS_STAGING_INSTANCE} dsudo:'service httpd start'
    ccg ${AWS_STAGING_INSTANCE} dsudo:'export SITE_URL=http://localhost/dm1'
    ...
    ccg ${AWS_STAGING_INSTANCE} dsudo:'killall httpd || true'
    ccg ${AWS_STAGING_INSTANCE} dsudo:'service httpd start'
    ccg ${AWS_STAGING_INSTANCE} dsudo:'export SITE_URL=http://localhost/dd'
