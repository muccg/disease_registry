...
function ci_staging_selenium() {
    ...
    ccg ${AWS_STAGING_INSTANCE} dsudo:'lettuce /usr/local/webapps/dmd/lib/django_dmdregistry-*.egg/dmd/dmd/features/login.feature --with-xunit --xunit-file\=/tmp/tests.xml'
