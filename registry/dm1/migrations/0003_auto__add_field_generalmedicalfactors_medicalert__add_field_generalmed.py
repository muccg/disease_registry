...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dm1_generalmedicalfactors', 'medicalert', self.gf('django.db.models.fields.CharField')(default='0', max_length=1), keep_default=False)

        # Adding field 'GeneralMedicalFactors.physiotherapy'
        db.add_column('dm1_generalmedicalfactors', 'physiotherapy', self.gf('django.db.models.fields.CharField')(default='2', max_length=1), keep_default=False)

        # Adding field 'GeneralMedicalFactors.geneticcounseling'
        db.add_column('dm1_generalmedicalfactors', 'geneticcounseling', self.gf('django.db.models.fields.CharField')(default='2', max_length=1), keep_default=False)

        # Adding field 'GeneralMedicalFactors.psychologicalcounseling'
        db.add_column('dm1_generalmedicalfactors', 'psychologicalcounseling', self.gf('django.db.models.fields.CharField')(default='2', max_length=1), keep_default=False)

        # Adding field 'GeneralMedicalFactors.speechtherapy'
        db.add_column('dm1_generalmedicalfactors', 'speechtherapy', self.gf('django.db.models.fields.CharField')(default='2', max_length=1), keep_default=False)

        # Adding field 'GeneralMedicalFactors.occupationaltherapy'
        db.add_column('dm1_generalmedicalfactors', 'occupationaltherapy', self.gf('django.db.models.fields.CharField')(default='2', max_length=1), keep_default=False)

        # Adding field 'GeneralMedicalFactors.vocationaltraining'
        db.add_column('dm1_generalmedicalfactors', 'vocationaltraining', self.gf('django.db.models.fields.CharField')(default='2', max_length=1), keep_default=False)

        # Adding field 'Muscle.myotonia_effect'
        db.add_column('dm1_muscle', 'myotonia_effect', self.gf('django.db.models.fields.CharField')(default='2', max_length=6), keep_default=False)

        # Adding field 'Heart.racing'
        db.add_column('dm1_heart', 'racing', self.gf('django.db.models.fields.CharField')(default='2', max_length=1), keep_default=False)

        # Adding field 'Heart.palpitations'
        db.add_column('dm1_heart', 'palpitations', self.gf('django.db.models.fields.CharField')(default='2', max_length=1), keep_default=False)

        # Adding field 'Heart.fainting'
        db.add_column('dm1_heart', 'fainting', self.gf('django.db.models.fields.CharField')(default='2', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GeneralMedicalFactors.medicalert'
        db.delete_column('dm1_generalmedicalfactors', 'medicalert')

        # Deleting field 'GeneralMedicalFactors.physiotherapy'
        db.delete_column('dm1_generalmedicalfactors', 'physiotherapy')

        # Deleting field 'GeneralMedicalFactors.geneticcounseling'
        db.delete_column('dm1_generalmedicalfactors', 'geneticcounseling')

        # Deleting field 'GeneralMedicalFactors.psychologicalcounseling'
        db.delete_column('dm1_generalmedicalfactors', 'psychologicalcounseling')

        # Deleting field 'GeneralMedicalFactors.speechtherapy'
        db.delete_column('dm1_generalmedicalfactors', 'speechtherapy')

        # Deleting field 'GeneralMedicalFactors.occupationaltherapy'
        db.delete_column('dm1_generalmedicalfactors', 'occupationaltherapy')

        # Deleting field 'GeneralMedicalFactors.vocationaltraining'
        db.delete_column('dm1_generalmedicalfactors', 'vocationaltraining')

        # Deleting field 'Muscle.myotonia_effect'
        db.delete_column('dm1_muscle', 'myotonia_effect')

        # Deleting field 'Heart.racing'
        db.delete_column('dm1_heart', 'racing')

        # Deleting field 'Heart.palpitations'
        db.delete_column('dm1_heart', 'palpitations')

        # Deleting field 'Heart.fainting'
        db.delete_column('dm1_heart', 'fainting')
