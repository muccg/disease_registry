...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dm1_consent', (
            ('q1', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('consentdate', self.gf('django.db.models.fields.DateField')()),
            ('firstnameparentguardian', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('lastnameparentguardian', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('consentdateparentguardian', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('doctor_0', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('doctoraddress_0', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('doctortelephone_0', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('specialist_0', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
    ...
    models = {
        ...
        'dm1.consent': {
            ...
            'consentdate': ('django.db.models.fields.DateField', [], {}),
            ...
            'q1': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
