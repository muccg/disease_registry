...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dm1_genetictestdetails', 'counselling', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'GeneticTestDetails.familycounselling'
        db.add_column('dm1_genetictestdetails', 'familycounselling', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GeneticTestDetails.counselling'
        db.delete_column('dm1_genetictestdetails', 'counselling')

        # Deleting field 'GeneticTestDetails.familycounselling'
        db.delete_column('dm1_genetictestdetails', 'familycounselling')
