...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('dm1_generalmedicalfactors', 'geneticcounseling', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
        ...
        # Adding field 'Respiratory.predictedfvc'
        db.add_column('dm1_respiratory', 'predictedfvc', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True), keep_default=False)

        # Changing field 'Respiratory.fvc'
        db.alter_column('dm1_respiratory', 'fvc', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'GeneralMedicalFactors.medicalert'
        db.alter_column('dm1_generalmedicalfactors', 'medicalert', self.gf('django.db.models.fields.CharField')(default='0', max_length=1))

        # Changing field 'GeneralMedicalFactors.occupationaltherapy'
        db.alter_column('dm1_generalmedicalfactors', 'occupationaltherapy', self.gf('django.db.models.fields.CharField')(default='0', max_length=1))

        # Changing field 'GeneralMedicalFactors.geneticcounseling'
        db.alter_column('dm1_generalmedicalfactors', 'geneticcounseling', self.gf('django.db.models.fields.CharField')(default='0', max_length=1))

        # Changing field 'GeneralMedicalFactors.vocationaltraining'
        db.alter_column('dm1_generalmedicalfactors', 'vocationaltraining', self.gf('django.db.models.fields.CharField')(default='0', max_length=1))

        # Changing field 'GeneralMedicalFactors.psychologicalcounseling'
        db.alter_column('dm1_generalmedicalfactors', 'psychologicalcounseling', self.gf('django.db.models.fields.CharField')(default='0', max_length=1))

        # Changing field 'GeneralMedicalFactors.physiotherapy'
        db.alter_column('dm1_generalmedicalfactors', 'physiotherapy', self.gf('django.db.models.fields.CharField')(default='0', max_length=1))

        # Changing field 'GeneralMedicalFactors.speechtherapy'
        db.alter_column('dm1_generalmedicalfactors', 'speechtherapy', self.gf('django.db.models.fields.CharField')(default='0', max_length=1))

        # Deleting field 'Respiratory.predictedfvc'
        db.delete_column('dm1_respiratory', 'predictedfvc')

        # Changing field 'Respiratory.fvc'
        db.alter_column('dm1_respiratory', 'fvc', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Heart.palpitations'
        db.alter_column('dm1_heart', 'palpitations', self.gf('django.db.models.fields.CharField')(default='0', max_length=1))

        # Changing field 'Heart.fainting'
        db.alter_column('dm1_heart', 'fainting', self.gf('django.db.models.fields.CharField')(default='0', max_length=1))

        # Changing field 'Heart.racing'
        db.alter_column('dm1_heart', 'racing', self.gf('django.db.models.fields.CharField')(default='2', max_length=1))
    ...
    models = {
        ...
        'dm1.respiratory': {
            ...
            'predictedfvc': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2', 'blank': 'True'})
        },
