...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Consent.doctor_1'
        db.add_column('dm1_consent', 'doctor_1', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctoraddress_1'
        db.add_column('dm1_consent', 'doctoraddress_1', self.gf('django.db.models.fields.CharField')(default=None, max_length=120, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctortelephone_1'
        db.add_column('dm1_consent', 'doctortelephone_1', self.gf('django.db.models.fields.CharField')(default=None, max_length=40, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.specialist_1'
        db.add_column('dm1_consent', 'specialist_1', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctor_2'
        db.add_column('dm1_consent', 'doctor_2', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctoraddress_2'
        db.add_column('dm1_consent', 'doctoraddress_2', self.gf('django.db.models.fields.CharField')(default=None, max_length=120, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctortelephone_2'
        db.add_column('dm1_consent', 'doctortelephone_2', self.gf('django.db.models.fields.CharField')(default=None, max_length=40, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.specialist_2'
        db.add_column('dm1_consent', 'specialist_2', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctor_3'
        db.add_column('dm1_consent', 'doctor_3', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctoraddress_3'
        db.add_column('dm1_consent', 'doctoraddress_3', self.gf('django.db.models.fields.CharField')(default=None, max_length=120, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctortelephone_3'
        db.add_column('dm1_consent', 'doctortelephone_3', self.gf('django.db.models.fields.CharField')(default=None, max_length=40, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.specialist_3'
        db.add_column('dm1_consent', 'specialist_3', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctor_4'
        db.add_column('dm1_consent', 'doctor_4', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctoraddress_4'
        db.add_column('dm1_consent', 'doctoraddress_4', self.gf('django.db.models.fields.CharField')(default=None, max_length=120, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctortelephone_4'
        db.add_column('dm1_consent', 'doctortelephone_4', self.gf('django.db.models.fields.CharField')(default=None, max_length=40, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.specialist_4'
        db.add_column('dm1_consent', 'specialist_4', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctor_5'
        db.add_column('dm1_consent', 'doctor_5', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctoraddress_5'
        db.add_column('dm1_consent', 'doctoraddress_5', self.gf('django.db.models.fields.CharField')(default=None, max_length=120, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctortelephone_5'
        db.add_column('dm1_consent', 'doctortelephone_5', self.gf('django.db.models.fields.CharField')(default=None, max_length=40, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.specialist_5'
        db.add_column('dm1_consent', 'specialist_5', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctor_6'
        db.add_column('dm1_consent', 'doctor_6', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctoraddress_6'
        db.add_column('dm1_consent', 'doctoraddress_6', self.gf('django.db.models.fields.CharField')(default=None, max_length=120, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctortelephone_6'
        db.add_column('dm1_consent', 'doctortelephone_6', self.gf('django.db.models.fields.CharField')(default=None, max_length=40, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.specialist_6'
        db.add_column('dm1_consent', 'specialist_6', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctor_7'
        db.add_column('dm1_consent', 'doctor_7', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctoraddress_7'
        db.add_column('dm1_consent', 'doctoraddress_7', self.gf('django.db.models.fields.CharField')(default=None, max_length=120, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctortelephone_7'
        db.add_column('dm1_consent', 'doctortelephone_7', self.gf('django.db.models.fields.CharField')(default=None, max_length=40, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.specialist_7'
        db.add_column('dm1_consent', 'specialist_7', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctor_8'
        db.add_column('dm1_consent', 'doctor_8', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctoraddress_8'
        db.add_column('dm1_consent', 'doctoraddress_8', self.gf('django.db.models.fields.CharField')(default=None, max_length=120, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctortelephone_8'
        db.add_column('dm1_consent', 'doctortelephone_8', self.gf('django.db.models.fields.CharField')(default=None, max_length=40, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.specialist_8'
        db.add_column('dm1_consent', 'specialist_8', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctor_9'
        db.add_column('dm1_consent', 'doctor_9', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctoraddress_9'
        db.add_column('dm1_consent', 'doctoraddress_9', self.gf('django.db.models.fields.CharField')(default=None, max_length=120, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.doctortelephone_9'
        db.add_column('dm1_consent', 'doctortelephone_9', self.gf('django.db.models.fields.CharField')(default=None, max_length=40, null=True, blank=True), keep_default=False)

        # Adding field 'Consent.specialist_9'
        db.add_column('dm1_consent', 'specialist_9', self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Consent.doctor_1'
        db.delete_column('dm1_consent', 'doctor_1')

        # Deleting field 'Consent.doctoraddress_1'
        db.delete_column('dm1_consent', 'doctoraddress_1')

        # Deleting field 'Consent.doctortelephone_1'
        db.delete_column('dm1_consent', 'doctortelephone_1')

        # Deleting field 'Consent.specialist_1'
        db.delete_column('dm1_consent', 'specialist_1')

        # Deleting field 'Consent.doctor_2'
        db.delete_column('dm1_consent', 'doctor_2')

        # Deleting field 'Consent.doctoraddress_2'
        db.delete_column('dm1_consent', 'doctoraddress_2')

        # Deleting field 'Consent.doctortelephone_2'
        db.delete_column('dm1_consent', 'doctortelephone_2')

        # Deleting field 'Consent.specialist_2'
        db.delete_column('dm1_consent', 'specialist_2')

        # Deleting field 'Consent.doctor_3'
        db.delete_column('dm1_consent', 'doctor_3')

        # Deleting field 'Consent.doctoraddress_3'
        db.delete_column('dm1_consent', 'doctoraddress_3')

        # Deleting field 'Consent.doctortelephone_3'
        db.delete_column('dm1_consent', 'doctortelephone_3')

        # Deleting field 'Consent.specialist_3'
        db.delete_column('dm1_consent', 'specialist_3')

        # Deleting field 'Consent.doctor_4'
        db.delete_column('dm1_consent', 'doctor_4')

        # Deleting field 'Consent.doctoraddress_4'
        db.delete_column('dm1_consent', 'doctoraddress_4')

        # Deleting field 'Consent.doctortelephone_4'
        db.delete_column('dm1_consent', 'doctortelephone_4')

        # Deleting field 'Consent.specialist_4'
        db.delete_column('dm1_consent', 'specialist_4')

        # Deleting field 'Consent.doctor_5'
        db.delete_column('dm1_consent', 'doctor_5')

        # Deleting field 'Consent.doctoraddress_5'
        db.delete_column('dm1_consent', 'doctoraddress_5')

        # Deleting field 'Consent.doctortelephone_5'
        db.delete_column('dm1_consent', 'doctortelephone_5')

        # Deleting field 'Consent.specialist_5'
        db.delete_column('dm1_consent', 'specialist_5')

        # Deleting field 'Consent.doctor_6'
        db.delete_column('dm1_consent', 'doctor_6')

        # Deleting field 'Consent.doctoraddress_6'
        db.delete_column('dm1_consent', 'doctoraddress_6')

        # Deleting field 'Consent.doctortelephone_6'
        db.delete_column('dm1_consent', 'doctortelephone_6')

        # Deleting field 'Consent.specialist_6'
        db.delete_column('dm1_consent', 'specialist_6')

        # Deleting field 'Consent.doctor_7'
        db.delete_column('dm1_consent', 'doctor_7')

        # Deleting field 'Consent.doctoraddress_7'
        db.delete_column('dm1_consent', 'doctoraddress_7')

        # Deleting field 'Consent.doctortelephone_7'
        db.delete_column('dm1_consent', 'doctortelephone_7')

        # Deleting field 'Consent.specialist_7'
        db.delete_column('dm1_consent', 'specialist_7')

        # Deleting field 'Consent.doctor_8'
        db.delete_column('dm1_consent', 'doctor_8')

        # Deleting field 'Consent.doctoraddress_8'
        db.delete_column('dm1_consent', 'doctoraddress_8')

        # Deleting field 'Consent.doctortelephone_8'
        db.delete_column('dm1_consent', 'doctortelephone_8')

        # Deleting field 'Consent.specialist_8'
        db.delete_column('dm1_consent', 'specialist_8')

        # Deleting field 'Consent.doctor_9'
        db.delete_column('dm1_consent', 'doctor_9')

        # Deleting field 'Consent.doctoraddress_9'
        db.delete_column('dm1_consent', 'doctoraddress_9')

        # Deleting field 'Consent.doctortelephone_9'
        db.delete_column('dm1_consent', 'doctortelephone_9')

        # Deleting field 'Consent.specialist_9'
        db.delete_column('dm1_consent', 'specialist_9')

        # Changing field 'Consent.doctoraddress_0'
        db.alter_column('dm1_consent', 'doctoraddress_0', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'Consent.doctortelephone_0'
        db.alter_column('dm1_consent', 'doctortelephone_0', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))
