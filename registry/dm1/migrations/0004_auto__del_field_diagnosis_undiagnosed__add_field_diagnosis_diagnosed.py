...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('dm1_diagnosis', 'undiagnosed')

        # Adding field 'Diagnosis.diagnosed'
        db.add_column('dm1_diagnosis', 'diagnosed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Diagnosis.undiagnosed'
        db.add_column('dm1_diagnosis', 'undiagnosed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Diagnosis.diagnosed'
        db.delete_column('dm1_diagnosis', 'diagnosed')
