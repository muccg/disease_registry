...
class Patient(models.Model):
    ...
    email = models.EmailField(blank=True)
    next_of_kin_family_name = models.CharField(max_length=100, blank=True, verbose_name="family name")
    next_of_kin_given_names = models.CharField(max_length=100, blank=True, verbose_name="given names")
    next_of_kin_relationship = models.ForeignKey(NextOfKinRelationship, verbose_name="Relationship", blank=True, null=True)
    next_of_kin_address = models.TextField(blank=True, verbose_name="Address")
    next_of_kin_suburb = models.CharField(max_length=50, blank=True, verbose_name="Suburb/Town")
    ...
    next_of_kin_home_phone = models.CharField(max_length=30, blank=True, verbose_name="home phone")
    next_of_kin_mobile_phone = models.CharField(max_length=30, blank=True, verbose_name="mobile phone")
    next_of_kin_work_phone = models.CharField(max_length=30, blank=True, verbose_name="work phone")
    next_of_kin_email = models.EmailField(blank=True, verbose_name="email")
    ...
    inactive_reason = models.TextField(blank=True, verbose_name="Reason", help_text="Please provide reason for deactivating the patient")
