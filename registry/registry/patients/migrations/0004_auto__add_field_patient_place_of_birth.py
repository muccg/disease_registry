...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.place_of_birth'
        db.add_column('patients_patient', 'place_of_birth',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.place_of_birth'
        db.delete_column('patients_patient', 'place_of_birth')
