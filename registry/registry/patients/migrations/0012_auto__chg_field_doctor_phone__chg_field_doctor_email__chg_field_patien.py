...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Doctor.phone'
        db.alter_column('patients_doctor', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Doctor.email'
        db.alter_column('patients_doctor', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))

        # Changing field 'Patient.next_of_kin_given_names'
        db.alter_column('patients_patient', 'next_of_kin_given_names', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Patient.next_of_kin_work_phone'
        db.alter_column('patients_patient', 'next_of_kin_work_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Patient.work_phone'
        db.alter_column('patients_patient', 'work_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Patient.next_of_kin_email'
        db.alter_column('patients_patient', 'next_of_kin_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))

        # Changing field 'Patient.home_phone'
        db.alter_column('patients_patient', 'home_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Patient.email'
        db.alter_column('patients_patient', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))

        # Changing field 'Patient.next_of_kin_family_name'
        db.alter_column('patients_patient', 'next_of_kin_family_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Patient.mobile_phone'
        db.alter_column('patients_patient', 'mobile_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Patient.next_of_kin_address'
        db.alter_column('patients_patient', 'next_of_kin_address', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Patient.next_of_kin_home_phone'
        db.alter_column('patients_patient', 'next_of_kin_home_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Patient.inactive_reason'
        db.alter_column('patients_patient', 'inactive_reason', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Patient.next_of_kin_mobile_phone'
        db.alter_column('patients_patient', 'next_of_kin_mobile_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=30))

        # Changing field 'Patient.place_of_birth'
        db.alter_column('patients_patient', 'place_of_birth', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Patient.next_of_kin_suburb'
        db.alter_column('patients_patient', 'next_of_kin_suburb', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

    def backwards(self, orm):

        # Changing field 'Doctor.phone'
        db.alter_column('patients_doctor', 'phone', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Doctor.email'
        db.alter_column('patients_doctor', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
        ...
        # Changing field 'Patient.next_of_kin_work_phone'
        db.alter_column('patients_patient', 'next_of_kin_work_phone', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Patient.work_phone'
        db.alter_column('patients_patient', 'work_phone', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Patient.next_of_kin_email'
        db.alter_column('patients_patient', 'next_of_kin_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'Patient.home_phone'
        db.alter_column('patients_patient', 'home_phone', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Patient.email'
        db.alter_column('patients_patient', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
        ...
        # Changing field 'Patient.mobile_phone'
        db.alter_column('patients_patient', 'mobile_phone', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Patient.next_of_kin_address'
        db.alter_column('patients_patient', 'next_of_kin_address', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Patient.next_of_kin_home_phone'
        db.alter_column('patients_patient', 'next_of_kin_home_phone', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Patient.inactive_reason'
        db.alter_column('patients_patient', 'inactive_reason', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Patient.next_of_kin_mobile_phone'
        db.alter_column('patients_patient', 'next_of_kin_mobile_phone', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Patient.place_of_birth'
        db.alter_column('patients_patient', 'place_of_birth', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
