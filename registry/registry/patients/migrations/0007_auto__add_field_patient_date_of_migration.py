...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('patients_patientparent', (
        ...
        db.send_create_signal('patients', ['PatientParent'])

        # Adding model 'Parent'
        db.create_table('patients_parent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('patients', ['Parent'])

        # Adding field 'Patient.date_of_migration'
        db.add_column('patients_patient', 'date_of_migration',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('patients_patientparent')

        # Deleting model 'Parent'
        db.delete_table('patients_parent')

        # Deleting field 'Patient.date_of_migration'
        db.delete_column('patients_patient', 'date_of_migration')
