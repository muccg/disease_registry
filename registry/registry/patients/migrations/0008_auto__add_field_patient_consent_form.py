...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.consent_form'
        db.add_column('patients_patient', 'consent_form',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.consent_form'
        db.delete_column('patients_patient', 'consent_form')
