...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.umrn'
        db.add_column('patients_patient', 'umrn',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=50, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.umrn'
        db.delete_column('patients_patient', 'umrn')
