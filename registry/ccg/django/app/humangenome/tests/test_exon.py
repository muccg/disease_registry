...
class TestExonVariation(unittest.TestCase):
    ...
    def test_parse_deletion(self):
        ...
        self.assertTrue(isinstance(ev.variations[0], Deletion), "Variation object is the wrong type")
        self.assertEqual(ev.variations[0].location.position, 42, "Variation position is incorrect")
    ...
    def test_parse_duplication(self):
        ...
        self.assertEqual(ev.gene, None, "Gene is set")
        self.assertTrue(isinstance(ev.variations[0], Duplication), "Variation object is the wrong type")
        self.assertEqual(ev.variations[0].location.position, 42, "Variation position is incorrect")
    ...
    def test_parse_nochange(self):
        ev = ExonVariation("42")
        self.assertEqual(ev.gene, None, "Gene is set")
        self.assertTrue(isinstance(ev.variations[0], NoChange), "Variation object is the wrong type")
        self.assertEqual(ev.variations[0].location.position, 42, "Variation position is incorrect")
