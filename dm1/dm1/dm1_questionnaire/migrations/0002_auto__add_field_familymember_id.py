...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FamilyMember.id'
        db.add_column('dm1_questionnaire_familymember', 'id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FamilyMember.id'
        db.delete_column('dm1_questionnaire_familymember', 'id')
