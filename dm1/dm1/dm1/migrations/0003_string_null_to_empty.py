...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        to_fix = [("dm1.FeedingFunction", ["gastic_nasal_tube", "dysphagia"]),
                  ("dm1.FamilyMember", ["relationship", "sex",
                                        "family_member_diagnosis"]),
                  ("dm1.GeneticTestDetails", ["counselling", "laboratory",
                                              "familycounselling"]),
                  ("dm1.SocioeconomicFactors", ["occupation",
                                                "education",
                                                "comments",
                                                "employment_effect"]),
                  ("dm1.Respiratory", ["non_invasive_ventilation_type",
                                       "non_invasive_ventilation",
                                       "invasive_ventilation"]),
                  ("dm1.Heart", ["ecg", "ecg_sinus_rhythm",
                                 "echocardiogram", "palpitations",
                                 "fainting", "racing", "condition"]),
                  ("dm1.OtherRegistries", ["registry"]),
                  ("dm1.Surgery", ["cardiac_implant", "cataract"]),
                  ("dm1.GeneralMedicalFactors", ["medicalert",
                                                 "occupationaltherapy",
                                                 "cancer",
                                                 "pneumonia",
                                                 "cancerothers",
                                                 ...
                                                 "physiotherapy",
                                                 "speechtherapy"]),
                  ("dm1.EthnicOrigin", ["ethnic_origin"]),
                  ("dm1.Diagnosis", ["first_symptom", "first_suspected_by"]),
                  ("dm1.Consent",
                   ["firstnameparentguardian",
                    ...
                    "doctortelephone_4"]),
                  ("dm1.Fatigue", ["fatigue"]),
                  ("dm1.MotorFunction", ["best_function"]),
                  ("dm1.ClinicalTrials", ["trial_phase",
                                          "drug_name",
                                          "trial_sponsor",
                                          "trial_name"]),
                  ("dm1.Muscle", ["myotonia",
