...
CSRF_COOKIE_NAME = "csrftoken_registry_dm1"

SESSION_COOKIE_NAME = "registry_dm1"
...
try:
    print "Attempting to import local settings as appsettings.dm1"
    from appsettings.dm1 import *
    print "Successfully imported appsettings.dm1"
except ImportError, e:
    print "Failed to import appsettings.dm1"
